...
updatePackageVersion('./src/main/package.json', newVersion);

if (userCodename.length > 0) {
  const codenameObj = fs.readJsonSync('./src/main/codenames.json');
  fs.writeJsonSync('./src/main/codenames.json', {
    ...codenameObj,
